...
<li><span class="news-date"><em>2026.03</em></span> 🎓🎓 Started my Ph.D. at the City University of Hong Kong.</li>
...
<div class="publication-card" data-category="all"> 
  <div style="display: flex; align-items: center;">
    ...
    <div>
      ...
      <i style="font-size: 13px;"><strong>Xutao Mao</strong>, Xiang Zheng, Cong Wang, et al.</i><br> 
...
<div class="publication-card" data-category="all"> 
  <div style="display: flex; align-items: center;">
    ...
    <div>
      ...
      <i style="font-size: 13px;"><strong>Xutao Mao</strong>, et al.</i><br> 
...
<div class="publication-card" data-category="all"> 
  <div style="display: flex; align-items: center;">
    ...
    <div>
      ...
      <i style="font-size: 13px;">Tao Liu*, <strong>Xutao Mao*</strong>, Hongying Zan, et al.</i><br> 
...
<div class="publication-card" data-category="all"> 
  <div style="display: flex; align-items: center;">
    ...
    <div>
      ...
      <i style="font-size: 13px;"><strong>Xutao Mao</strong>, Cong Wang, et al.</i><br> 
...
<div class="publication-card" data-category="all"> 
  <div style="display: flex; align-items: center;">
    ...
    <div>
      ...
      <i style="font-size: 13px;"><strong>Xutao Mao</strong>, Bo Han, Cong Wang, et al.</i><br> 
...
<div class="publication-card" data-category="all"> 
  <div style="display: flex; align-items: center;">
    ...
    <div>
      ...
      <i style="font-size: 13px;"><strong>Xutao Mao</strong>, Cong Wang, Bo Han, et al.</i><br> 
...
<div id="full-publications" class="publication-view" data-publication-view="list" hidden>
  <ul class="full-publication-list">
    <li>
      ...
      <span class="pub-list-authors"><strong>Xutao Mao</strong>, Xiang Zheng, Cong Wang, et al.</span>
      <span class="pub-list-note">Poster.</span>
      <span class="pub-list-links"><a href="https://arxiv.org/abs/2605.00699" target="_blank">[arXiv]</a></span>
    </li>
    <li>
      ...
      <span class="pub-list-authors"><strong>Xutao Mao</strong>, et al.</span>
    ...
    <li>
      ...
      <span class="pub-list-authors">Tao Liu*, <strong>Xutao Mao*</strong>, Hongying Zan, et al.</span>
      <span class="pub-list-note">Poster.</span>
    ...
    <li>
      ...
      <span class="pub-list-authors"><strong>Xutao Mao</strong>, Cong Wang, et al.</span>
      <span class="pub-list-note">Under Review.</span>
      <span class="pub-list-links"><a href="https://github.com/henrymao2004/Auto-research-red-teaming" target="_blank">[code]</a></span>
    </li>
    <li>
      <span class="pub-list-badge">Preprint</span>
      ...
      <span class="pub-list-authors"><strong>Xutao Mao</strong>, Bo Han, Cong Wang, et al.</span>
      <span class="pub-list-note">Under Review.</span>
    ...
    <li>
      ...
      <span class="pub-list-authors"><strong>Xutao Mao</strong>, Cong Wang, Bo Han, et al.</span>
      <span class="pub-list-note">Under Review.</span>
...
Services
--------
- Reviewer, AAAI 2026 · TheWebConf 2026 · NeurIPS 2026.
